// somavr_xrsim64 internals: the global state singleton, the object tables, and the
...
struct SimSwapchain {
    ...
    GLuint images[kMaxSwapchainImages] = {};
    bool acquired = false;
...
struct SimAction {
    ...
    // OpenXR actions may expose independent left/right subactions. Keeping one
    // control here makes the last suggested binding silently steal both hands.
    VirtualControl controls[2] = {VC_NONE, VC_NONE};
    bool syncInitialized[2] = {false, false};
    bool syncedActive[2] = {false, false};
    bool syncedBool[2] = {false, false};
    bool changed[2] = {false, false};
    float syncedFloat[2] = {0.0f, 0.0f};
    XrVector2f syncedVector[2] = {};
    XrTime lastChangeTime[2] = {0, 0};
};
...
struct Globals {
    ...
    char runtimeName[XR_MAX_RUNTIME_NAME_SIZE] = "somavr-xrsim";
