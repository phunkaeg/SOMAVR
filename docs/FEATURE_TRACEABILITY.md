...
| `FEATURE.PHYSICS_HANDS` | BUILT | `HPLGrabBridge`, `HPLInputBridge`, `OpenXRInput` | exact vector PID output `0x140238750`, Grab state `1`, force gains `400/0/40`, torque gains `40/0/0.4|0.1`, controller pose/velocity | `VR_COMPATIBILITY_RE.md`, `FUTURE_SYSTEMS_RE.md`, `BUILD_HISTORY.md`, `TEST_CHECKLISTS.md` | Live-test translation stability and native rotate/throw mappings; correlate torque error to controller orientation, then add guarded rotational target and velocity-scaled release |
