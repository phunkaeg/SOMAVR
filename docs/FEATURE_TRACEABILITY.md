...
| `FEATURE.HUD_LAYER` | EXPERIMENTAL | `HPLCompatibilityProbe`, `OpenGLHooks`, future GUI capture bridge | `0x1402981e0`, `0x14022f8e0`, `0x140213970`, GUI-set fields, `XrCompositionLayerQuad` | `FUTURE_SYSTEMS_RE.md` | Classify gameplay/menu/subtitle/terminal sets from per-object telemetry, then redirect only flat HUD sets to an alpha target |
