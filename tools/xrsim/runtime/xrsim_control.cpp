// somavr_xrsim64: the control channel.
//
...
//
// Two deliberate properties keep the test control path deterministic:
//
...
//
// It also discards a command.txt older than its own start time. A leftover
