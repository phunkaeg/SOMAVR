...
struct Config {
    ...
    float hplControllerSlideVelocityScale = 1.25f;
    float hplControllerSlidePositionGain = 18.0f;
    float hplControllerSlideMaxVelocityMetersPerSecond = 2.5f;
    bool hplControllerRotateDirectVelocity = true;
    float hplControllerRotateVelocityScale = 1.5f;
    ...
    float hplControllerReadObjectDistanceScale = 1.5f;
