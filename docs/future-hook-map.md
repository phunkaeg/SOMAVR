...
| `Soma_NoSteam.exe+0x0cd710` | Static-world control call built | Registered `CheckLineOfSight` wrapper | `0.24.0` directly calls the signature-guarded four-argument wrapper to clamp physical-head translation; no detour and no script ownership change. |
