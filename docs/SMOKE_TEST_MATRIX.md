...
| S02 | Quiet lit room | Press F10, inspect stereo, translate/rotate HMD, walk around reflective and shadowed surfaces | VR activation, alternating eyes, zero projection offset, submitted frames | Skew, scale drift, eye mismatch, moving shadows/reflections, or wrong eye height |
