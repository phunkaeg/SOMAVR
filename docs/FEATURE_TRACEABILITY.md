...
| `FEATURE.XR_DEPTH_CAPABILITY` | EXPERIMENTAL | `OpenXRRuntime`, `HPLCameraBridge` | `XR_KHR_composition_layer_depth`, `GL_DEPTH_BITS`, `GL_DEPTH_RANGE`, HPL near/far | `FUTURE_SYSTEMS_RE.md`, `VR_COMPATIBILITY_RE.md`, `TEST_CHECKLISTS.md` | Confirm runtime support and eye-owned depth semantics before implementing depth swapchains/submission |
