...
| `FEATURE.PHYSICS_HANDS` | BUILT | `HPLGrabBridge`, `HPLGrabMath`, `HPLTwoHandMath`, `HPLInputBridge`, `OpenXRInput` | PID output `0x140238750`, body matrix `+0x50`, angular velocity vtable `+0x90`, bounded absolute angular error, AddImpulse thunk `0x14049c720`, Grab state `1`, selected-hit-to-grip correction, state-lifetime owner lock | `VR_COMPATIBILITY_RE.md`, `FUTURE_SYSTEMS_RE.md`, `BUILD_HISTORY.md`, `TEST_CHECKLISTS.md` | Live-test jitter-free one/two-hand rotation, bounded pull/catch, hold stability, placement, velocity-directed throws, crossed-beam ownership, mass classes, and fallbacks |
| `FEATURE.PHYSICAL_MANIPULATION` | BUILT | `HPLGrabBridge`, `HPLGrabMath`, `HPLReadMath`, `HPLInputBridge`, `HPLInputMath`, `HPLInteractionBridge`, `OpenXRInput` | states Wheel `3`, Slide `4`, Door `5`, Lever `6`, Tear `7`, Read `10`; PID `0x140238750`, pin `+0xe8`, grip/body displacement catch-up, pivot `+0xf4`; native Read travel plus persistent full-axis grip orientation | `FUTURE_SYSTEMS_RE.md`, `ADDRESS_REGISTRY.md`, `BUILD_HISTORY.md`, `TEST_CHECKLISTS.md` | Live-test curtain/drawer position following, wrist-driven taps/levers, Read cancel/camera stability; preserve native limits, physics, sounds, callbacks, and rollback |
