...
| `0x1403f40d0` | Confirmed, future per-eye candidate | Local-reflection render path uses accumulation/copy resources around `+0xea0/+0xeb0/+0xf00`. It remains native in `0.54.0` pending live ownership evidence. Ghidra: `HPL3_RendererDeferred_RenderLocalReflection`. |
