...
| S08 | Authored camera event | Trigger sit/conversation/ladder/climb/camera animation and move HMD throughout | Exact state-transition rows, bounded black guards, semantic roll rows, controller suppression, live head tracking | Frozen head, persistent blackout, forced roll, double rotation, controller movement, or beam override |
